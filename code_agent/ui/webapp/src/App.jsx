			...
			<ReactMarkdown
				...
				components={{
					...
					code({ node, inline, className, children, ...props }) {
						...
						return inline ? (
							<code {...props} style={{ fontFamily: "monospace", background: "#f5f5f5", padding: "0.2em 0.4em", borderRadius: "3px" }}>
								{children}
							</code>
						) : (
							<pre {...props} style={{ background: "#f5f5f5", padding: "1em", borderRadius: "5px", overflow: "auto" }}>
		...
		<div style={{ display: "flex", gap: "0.5rem" }}>
			<textarea
				...
				style={{
					...
					padding: "0.6rem",
					borderRadius: "6px",
					border: disabled ? "1px solid #ccc" : "1px solid #ccc",
					fontFamily: "inherit",
