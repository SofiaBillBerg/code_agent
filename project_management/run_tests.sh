...
#run_step "pytest" uv run pytest --cov=code_agent tests/ --cov-report lcov --cov-report=term-missing  --cov-report markdown:"$CODE_QUALITY_DIR/cov.md"  --color=yes --tb=short --junitxml="$CODE_QUALITY_DIR/pytest_report.xml"
