...
`code_agent` API is documented with pydoctor. The full API reference is available
at [apidocs](../apidocs/apidocs-help.html).

![Agent overview](../docs/visualizations/svg/packages_code_agent.svg)
...
The `code_agent.agent` module provides the core functionality of the code agent, including the agent's decision-making
