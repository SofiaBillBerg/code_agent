...
```markdown
![Capabilities diagram](../docs/visualizations/png/packages_berg_agents.capabilities.png)
```
...
MCP (Model Context Protocol) servers extend the agent with external tools. Configure them via `BERG_AGENT_MCP_SERVERS`
