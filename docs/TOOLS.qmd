...
Create a new file in the [`code_agent/tools/`](../code_agent/tools/) directory. Your tool should be a class that inherits from `BaseTool` and defines its `name`, `description`, and `_run` method.
