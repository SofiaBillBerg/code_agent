...
- **Agent Usage**:
  ...
  Resource:  [`code_agent//utils/utils.py`](../code_agent/utils/utils.py).
...
- **Agent Usage**:
  > **User**: "Add a new function to `code_agent/utils/utils.py` that subtracts two numbers."
  Resource:  [`code_agent//utils/utils.py`](../code_agent/utils/utils.py).
...
- **Agent Usage**:
  > **User**: "Generate tests for  [`code_agent//utils/utils.py`](../code_agent/utils/utils.py)."
...
- **Agent Usage**:
  ...
  Reference: [code_agent/main.py](../code_agent/main.py)
...
Create a new file in the [`code_agent/tools/`](../code_agent/tools/__init__.py) directory. Your tool should be a class
that inherits from `BaseTool` and defines its `name`, `description`, and `_run` method.
...
Add your new tool to the `create_default_tools` function in [`code_agent/agents/base_agent.py`](../code_agent/agents/base_agent.py).
